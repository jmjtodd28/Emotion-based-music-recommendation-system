...
def get_landmark_coords(test_or_train):
    ...
    csv_file_path = 'face_landmarks_' + test_or_train + '.csv'
    headers = ['label']
    ...
    #The training set has 28709 photos and the test set has 8299 photos
    ...
    emotions = os.listdir('archive/' + test_or_train)

    for emotion in emotions:
        IMAGE_FILES = os.listdir('archive/' + test_or_train + '/' + emotion)
        ...
        with mp_holistic.Holistic(static_image_mode=True,
            ...
            for i, file in enumerate(IMAGE_FILES):
                ...
                file_path = 'archive/' + test_or_train + '/' + emotion + '/' + file
                try:
    ...
    print(f"Landmark coordinates completed for {test_or_train}")
    print('df shape: ', df.shape)

get_landmark_coords('train')
get_landmark_coords('test')